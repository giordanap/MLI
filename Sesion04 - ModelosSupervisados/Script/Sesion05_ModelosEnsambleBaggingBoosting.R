...
datosDes_Imp=datosDes_Imp$data[,1:min(dim(DespliegueD))]

summary(datosDes_Imp)

datosDes_Imp$Loan_ID <- NULL

# Prediccion con XGBoost

library(xgboost)
Mdespliegue_XGB <- model.matrix(~ ., data=datosDes_Imp)
